...
![img](jvm分析调优.assets/v2-1625a1be5c7a79e2cecdf370257ea37b_1440w.webp)
...
![img](jvm分析调优.assets/v2-ae252f845c9f21ae1644e3d28ab91bd6_1440w.webp)
...
![img](jvm分析调优.assets/v2-edf67a81a0481a4b3defed3bc75968f3_1440w.webp)
...
![img](jvm分析调优.assets/v2-533a3d832da1f70246dfeeb776a86e7c_1440w.webp)
...
![img](jvm分析调优.assets/v2-54f3bee00f8276952eada1b222adea3f_1440w.webp)
...
![img](jvm分析调优.assets/v2-c8ee67607571aa1c35027faba2b9daa0_1440w.webp)
...
![img](jvm分析调优.assets/v2-51c3ce249407ce52a9541de9a53c9c88_1440w.webp)
...
![img](jvm分析调优.assets/v2-8929ba45a408c4c7e1a0c26e482ff3f9_1440w.webp)


找到当前运行的类，查看线程，就会看到最头上的一排红字：检测到死锁。然后点击“线程Dump”按钮，查看相信的线程死锁的信息。

![img](jvm分析调优.assets/v2-eda8e7c1e4db8a61aaed5372d9df2b36_1440w.webp)
...
![img](jvm分析调优.assets/v2-59bdeb2b2c34f58a5f90ef5b6109338f_1440w.png)
...
![img](jvm分析调优.assets/v2-aa09ce07d0ef35bdf4d0c240df3dbc05_1440w.webp)
...
![img](jvm分析调优.assets/v2-b49e4b6829d9352cf7ef76b396446448_1440w.png)
...
![img](jvm分析调优.assets/v2-6c7cf3e2d58a57d77f93481def045e94_1440w.webp)
...
![img](jvm分析调优.assets/v2-d07195d5c56ef947c531a770acf1f95c_1440w.png)
...
![img](jvm分析调优.assets/v2-c01d92c41ce1142527b1803486e52471_1440w.webp)
...
![img](jvm分析调优.assets/v2-5229be8dc31b4b0eefa4e64300441fbb_1440w.png)
...
Arthas的功能非常强大，现附上官方文档：[https://arthas.aliyun.com/doc/](https://link.zhihu.com/?target=https%3A//arthas.aliyun.com/doc/)
...
可以直接在Linux上通过命令下载：
wget [https://alibaba.github.io/arthas/arthas-boot.jar](https://link.zhihu.com/?target=https%3A//alibaba.github.io/arthas/arthas-boot.jar)
也可以在浏览器直接访问[https://alibaba.github.io/arthas/arthas-boot.jar](https://link.zhihu.com/?target=https%3A//alibaba.github.io/arthas/arthas-boot.jar)，等待下载成功后，上传到Linux服务器上。
...
![img](jvm分析调优.assets/v2-eaf2817906086e69904f92bf0d22a250_1440w.png)


然后找到你想监控的进程，输入前面对应的编号，就可以开启进行监控模式了。比如我要看4

![img](jvm分析调优.assets/v2-ec08055b686a91d1bb7c927502ac785a_1440w.webp)
...
![img](jvm分析调优.assets/v2-30a434cfc384cbe2f0eba9b5de62cdfd_1440w.webp)
...
[os.name](https://link.zhihu.com/?target=http%3A//os.name/)：当前使用的操作系统 Mac OS X
...
![img](jvm分析调优.assets/v2-0cf332fcc2d4f0f277ab85bc7ec6f339_1440w.png)

Load < 1

![img](jvm分析调优.assets/v2-5b676583363e438a554c7942bd80c71c_1440w.png)

Load = 1

![img](jvm分析调优.assets/v2-13056ae21720d58c3f5047f728a5f8e6_1440w.webp)
...
![img](jvm分析调优.assets/v2-5d2b378b932d59e297a7c4d17aa7b49d_1440w.png)
...
![img](jvm分析调优.assets/v2-6292d4541bca478daa54c5123ad3a374_1440w.webp)
...
![img](jvm分析调优.assets/v2-4a3b97a4d555b92fcff54349a8871381_1440w.webp)
...
![img](jvm分析调优.assets/v2-30e7190c4c8c7ab1fac47b0f60f64047_1440w.png)
...
![img](jvm分析调优.assets/v2-14ed15fe889b31cde17c0cc671ebfb53_1440w.webp)
...
![img](jvm分析调优.assets/v2-8205eb6247fadcfa1015d9d8e8b8f9b2_1440w.webp)
...
![img](jvm分析调优.assets/v2-ec8882d3b6e37f61bf66c8150767cd8d_1440w.png)
...
![img](jvm分析调优.assets/v2-fc4010ce4de7918a259d1e2e5b3940da_1440w.png)
...
![img](jvm分析调优.assets/v2-ee150d60df7267e1fe7ced0d1628e845_1440w.webp)
...
![img](jvm分析调优.assets/v2-9e5ca2cce76fd4bf0ea11d4acaa17188_1440w.webp)
...
![img](jvm分析调优.assets/v2-f22f5af8598e59f70e0039250a5138f3_1440w.png)
...
![img](jvm分析调优.assets/v2-8240cdfd47b844ccba873021ca168adc_1440w.png)
...
![img](jvm分析调优.assets/v2-ee0d6c47111f22b1a3601b0db04c1cd5_1440w.webp)
...
![img](jvm分析调优.assets/v2-174a20b5c676e3c3f2d0dff7b2f99185_1440w.webp)
...
![img](jvm分析调优.assets/v2-c3ac41418694a5de7e9d0aa3df2d9ace_1440w.png)
...
使用sc命令查看JVM已加载的类信息。关于sc命令，查看官方文档：[https://arthas.aliyun.com/doc/sc.html](https://link.zhihu.com/?target=https%3A//arthas.aliyun.com/doc/sc.html)

- -d ： 表示打印类的详细信息

![img](jvm分析调优.assets/v2-51cc37ecbb611d8273b5e1cc6eef8251_1440w.webp)
...
- mc: 编译.java文件生.class文件， 详细使用方法参考官方文
- [https://arthas.aliyun.com/doc/mc.html](https://link.zhihu.com/?target=https%3A//arthas.aliyun.com/doc/mc.html)
...
![img](jvm分析调优.assets/v2-25b5cc715a07632261d8d0bade61df57_1440w.webp)
...
![img](jvm分析调优.assets/v2-2107433ebc80cabb439c830c71afe96f_1440w.png)
...
![img](jvm分析调优.assets/v2-074b8ac917f3ac488aa0afbad413ba38_1440w.png)
...
![img](jvm分析调优.assets/v2-bbd30561df27c9b970c2beb035599b87_1440w.webp)
...
![img](jvm分析调优.assets/v2-d23c403fb88f22002e249e0249abb491_1440w.webp)

## 9. 查询jvm信息，并修改----当发生内存溢出时，可以手动设置打印堆日志到文件

通常查询jvm参数，使用的是Java自带的工具[jinfo 进程号]。arthas中通过vmoption获取jvm参数：

![img](jvm分析调优.assets/v2-0b422ee7187e23196378fdfc6fce5202_1440w.webp)
...
```
![img](jvm分析调优.assets/v2-c20660cc84ff924dde5b5c08a15c6ebc_1440w.webp)
...
![img](jvm分析调优.assets/v2-97b4ebac55418efe05667e167a3f5fb1_1440w.webp)
...
[一次jvm调优实战 | HeapDump性能社区](https://link.zhihu.com/?target=https%3A//heapdump.cn/article/1825453)

[记一次简单的 JVM 调优 | HeapDump性能社区](https://link.zhihu.com/?target=https%3A//heapdump.cn/article/1812465)

[JVM故障分析及性能优化系列之一：使用jstack定位线程堆栈信息](https://link.zhihu.com/?target=https%3A//heapdump.cn/article/2711530)

[JVM故障分析及性能优化系列之二：jstack生成的Thread Dump日志结构解](https://link.zhihu.com/?target=https%3A//heapdump.cn/article/2713097)

[JVM故障分析及性能优化系列之三：jstat命令的使用及VM Thread分析](https://link.zhihu.com/?target=https%3A//heapdump.cn/article/2716081)

[JVM故障分析及性能优化系列之四：jstack生成的Thread Dump日志线程状态](https://link.zhihu.com/?target=https%3A//heapdump.cn/article/2780900)

[JVM故障分析及性能优化系列之五：常见的Thread Dump日志案例分析](https://link.zhihu.com/?target=https%3A//heapdump.cn/article/2812438)

[JVM故障分析及性能优化系列之六：JVM Heap Dump（堆转储文件）的生成和MAT的使用](https://link.zhihu.com/?target=https%3A//heapdump.cn/article/2836272)

[JVM故障分析及性能优化系列之七：使用MAT的Histogram和Dominator Tree定位溢出源](https://link.zhihu.com/?target=https%3A//heapdump.cn/article/2844891)

[线上一次简单的 JVM 调优，性能提升了15%](https://link.zhihu.com/?target=https%3A//heapdump.cn/article/3539264)

[一次大量 JVM Native 内存泄露的排查分析（64M 问题）](https://link.zhihu.com/?target=https%3A//heapdump.cn/article/3530243)

[JVM调优1个月，性能提升400倍！怎样做到的？](https://link.zhihu.com/?target=https%3A//heapdump.cn/article/3499165)